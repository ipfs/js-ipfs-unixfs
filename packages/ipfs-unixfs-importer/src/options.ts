...
import type { ImporterOptions, UserImporterOptions } from './index.js'
...
const defaultOptions: ImporterOptions = {
  ...
  polynomial: 17437180132763653, // eslint-disable-line no-loss-of-precision,@typescript-eslint/no-loss-of-precision
  ...
  timeout: undefined,
  hamtHashFn,
  hamtHashCode: BigInt(0x22),
  hamtBucketBits: 8
}

export default (options: UserImporterOptions = {}): ImporterOptions => {
