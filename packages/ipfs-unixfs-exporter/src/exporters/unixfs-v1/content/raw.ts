...
import type { ExportContentOptions, ExportProgress, ExportWalk } from '../../../index.js'
import type { PBNode } from '@ipld/dag-pb'
import type { UnixFS } from 'ipfs-unixfs'
import type { CID } from 'multiformats'

export function rawContent (cid: CID, node: PBNode, unixfs: UnixFS): (options: ExportContentOptions) => AsyncGenerator<Uint8Array> {
  async function * yieldRawContent (options: ExportContentOptions = {}): AsyncGenerator<Uint8Array, void, undefined> {
    if (unixfs.data == null) {
